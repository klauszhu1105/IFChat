...
<template>
    <div class="chat-container" @click="showEmoji = false" :style="containerAni">
        ...
        <div class="not-to-choose" v-if="empty">
            ...
            <h3 style="margin-top: 40px;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">欢迎使用 IF Chat</h3>
            <span style="color: #838384;font-size: 13px;margin-top: 10px;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">开始聊天吧！</span>
        </div>
        <div class="content">
                        ...
                        <div class="aChat" style="white-space: pre-wrap;" :class="item.type">
                            ...
                            <div v-else-if="item.type == 'image'">
                                <el-image :src="getPath(item.content)" :alt="item.content"
                                    style="width: 150px;object-fit:contain" :preview-src-list="[getPath(item.content)]" />
                            </div>
                            <div v-else-if="item.type == 'video'">
                                <video :src="getPath(item.content)" muted style="width: 100px;object-fit:contain"></video>
                                <!-- <div class="play-btn" @click="showVideoDialog = true, currentVideo = getPath(item.content)">
                                    <img src="@/assets/chat/play.png" alt="" width="45">
                                </div> -->
                                <div class="play-btn" @click="downloadFile(item.content)">
                                    <img src="@/assets/chat/play.png" alt="" width="45">
                                </div>
                            </div>
